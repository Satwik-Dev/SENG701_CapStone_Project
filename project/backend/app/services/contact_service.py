...
class ContactService:
    def __init__(self, client: Client):
        ...
        self.smtp_port = 587
        self.smtp_email = settings.SMTP_EMAIL      # FROM SETTINGS
        self.smtp_password = settings.SMTP_PASSWORD  # FROM SETTINGS
        self.recipient_email = settings.RECIPIENT_EMAIL  # FROM SETTINGS
